...
function DataInformation() {
  return (
    <div class="content">
      <p type="first"> utiliza três fontes de dados para classificar os artigos em periódico, todas incluídas junto com a ferramenta:</p>
        <ul>
      ...
      <p>Os dados desta fonte foram coletados do <a href="https://www.scopus.com/sources.uri" target="_blank">portal da Scopus</a>, em maio de 2021, e incluem os percentis de 25.990 periódicos internacionais de todas as áreas do conhecimento (ano-base 2020). classifica os periódicos encontrados exclusivamente nesta fonte tomando como base as <a href="https://www.in.gov.br/en/web/dou/-/portaria-n-145-de-10-de-setembro-de-2021-344468240" target="_blank">regras de distribuição de percentis</a> estabelecidas pela CAPES: </p>
      <table class="styled-table" id="percentil-rule-table">
        <thead>
          <tr>
      ...
      <p> consulta uma fonte de dados de cada vez, por ordem de atualização dos dados de cada fonte, da mais recente (CAPES) à mais antiga (Scopus), utilizando o ISSN dos periódicos extraído do CVs como chave de busca. Se os dados de um periódico não forem encontrados na primeira fonte de dados consultada, a ferramenta busca esses dados na próxima fonte de dados, e assim sucessivamente.</p>
